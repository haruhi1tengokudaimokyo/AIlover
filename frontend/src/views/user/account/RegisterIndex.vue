...
<template>
  <div class = "flex justify-center mt-30">
      <fieldset class="fieldset bg-base-200 border-base-300 rounded-box w-xs border p-4">
        ...
        <button class="btn btn-neutral mt-4" @click="handleRegister">注册</button>
        <div class = 'flex justify-end'>
          <RouterLink :to="{name: 'user-account-login-index'}" class = "btn btn-sn btn-ghost text-gray-500">注册</RouterLink>
        </div>
      </fieldset>
    </div>
</template>
